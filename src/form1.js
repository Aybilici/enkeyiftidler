...
class form1 extends Component {
  ...
  handleSubmit = event => {
    ...
    axios
      .post('http://www.enkeyiflitid.com/api/api/Employees/post', stringify(Employee))
                    ...
                    <div className='dis-flex size1 p-b-47'>
                      <div className='flex-col size2'>
                        ...
                        <span className='txt3'>
                          ...
                          Tanışma Eğitimi ile ilgili şunları
                          bilmenin iyi olacağını düşündük:
                          <br />
                          <br />
                          <ol>
                            ...
                            <li>
                              ...
                              arasında her cumartesi 11:00 - 14:00 arasında olacak.
                            </li>
                            <br />
                            <li>
                              3.Her bir buluşma 3 saat sürecek ve -keyifli- 8
                            ...
                            <br />
                            <li>
                              6. Başvurular için son tarih 23 Eylül Pazartesi. Değerlendirme sonuçları ise 30 Eylül Pazartesi
                              günü e-posta yoluyla bildirilecek.
                            </li>
                            <br />
                            <li>
